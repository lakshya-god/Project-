...
con=sqltor.connect(host="localhost",user="root",password="luvkush12")
cur=con.cursor()
...
def apoint():
    ...
    frame.pack()
    l1=Label(root2,text="Patient_ID NO.")
    l1.place(x=10,y=130)
...
def ser_avail():
    ...
    l5=Label(root5,text='To avail any of these please contact on our number:- 987XXXYYYY')
    l5.place(x=20,y=240)
...
def mod_sub():
    ...
    frame.pack()
    l1=Label(root7,text="Patient_ID NO.")
    l1.place(x=10,y=130)
